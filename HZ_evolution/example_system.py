...
#look at L Teff log(g) FeH output


#K2-18b properties
star_Teff=3464.0 #from TIC
star_dTeff=157.0
star_logg=4.7864000 #TIC
star_dlogg=0.0057881
star_feh=0.12 #Sarkis 2018
star_dfeh=0.16
star_logL= -1.59122 #TIC
star_dlogL= 0.107

target_dict={'Teff':(star_Teff,star_dTeff),
             'logg':(star_logg,star_dlogg*20),
             'feh':(star_feh,star_dfeh),
             'logL':(star_logL,star_dlogL)}

#%% define priors
#pars=[mass,eep,feh]
prior_arr=[st.norm(loc=0.44,scale=0.05),
           st.uniform(loc=200,scale= 150),  #max eep 350 corresponds to 35 Gyr age for mass upper bound
           st.norm(loc=0.0,scale=0.1)]
